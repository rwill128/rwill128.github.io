...
export const STEPS = [
  ...
  quantum(1, 0, 0, {
    ...
    body: () => [
      "The input qubit x and target qubit y both begin in |0⟩. Writing the two labels together gives the joint basis state |00⟩, where the first digit belongs to x and the second belongs to y.",
      "Only the amplitude of |00⟩ is nonzero, and that amplitude is 1. The joint state is a product state because it can be written as one independent state for x multiplied by one independent state for y.",
  ...
  quantum(3, 2, 2, {
    ...
    mathStage: "After H(y)",
    body: () => [
      "Hadamard maps |1⟩ to |−⟩ = (|0⟩ − |1⟩)/√2. The target now contains equal-magnitude components with opposite signs.",
  ...
  quantum(4, 3, 3, {
    ...
    mathStage: "After H(x)",
    body: () => [
      "Hadamard maps the input |0⟩ to |+⟩ = (|0⟩ + |1⟩)/√2. The complete state now contains both possible x values, each paired with the same target state |−⟩.",
  ...
  interpretation(3, 5, {
    ...
    body: (oracle) => [
      ...
      "The improvement is modest but historically decisive: one exact quantum query instead of two deterministic classical queries. It supplied a concrete primitive for later algorithms: represent a global property in phase, then engineer interference that suppresses wrong answers and reinforces useful ones. See <a href=\"https://quantum.cloud.ibm.com/learning/en/courses/fundamentals-of-quantum-algorithms/quantum-query-algorithms/deutsch-algorithm\">IBM Quantum's full derivation of Deutsch's algorithm</a>.",
    ],
    equations: (oracle) => [
