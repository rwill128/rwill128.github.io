...
const steps = [
  {
    kicker: "The problem",
    title: "Why factoring becomes period finding",
    operation: "None",
    stateLabel: "Before the circuit",
    circuitStep: 0,
    focus: [],
    body: [
  ...
  {
    kicker: "Classical setup",
    title: "Choose a base that is coprime to 15",
    ...
    body: [
      ...
      "The unknown we ask the quantum stage to reveal is the smallest positive <strong>r</strong> for which 2<sup>r</sup> returns to 1 modulo 15. We can see the answer by hand for this tiny demonstration, but doing the analogous search for cryptographically large numbers is the hard part.",
    ],
    equations: [
      "gcd(2, 15) = 1",
      "2⁰, 2¹, 2², 2³, 2⁴ (mod 15) = 1, 2, 4, 8, 1",
      "The first return to 1 occurs at r = 4.",
    ],
    facts: [
      ["Chosen base", "a = 2"],
      ["Classical check", "gcd = 1"],
      ["Hidden period", "r = 4"],
      ["Repeating values", "1, 2, 4, 8"],
    ],
  },
  {
    ...
    body: [
      ...
      "At this point every qubit is individually pure and points to |0⟩ on its Bloch sphere. The joint state is therefore a simple tensor product. There is only one nonzero basis amplitude: the amplitude of |000⟩|0000⟩ is 1.",
    ],
    equations: [
      "|Ψ₀⟩ = |000⟩<sub>count</sub> ⊗ |0000⟩<sub>work</sub>",
      "dim(|Ψ⟩) = 2³ × 2⁴ = 128 complex amplitudes",
    ],
    facts: [
      ["Counting range", "0…7"],
      ["Work range", "0…15"],
